...
class Events extends Component {
  ...
  GettingActiveRegistrationStatus = () => {
    ...
    return (
      <div className="over-all-container">
        <div className="main-container1">
          <h1 className="heading1">Events</h1>
          <ul className="events-container">
            {eventsList.map(eachItem => (
              <EventItem
                EventItemData={eachItem}
                key={eachItem.id}
                settingActiveId={this.settingActiveId}
        ...
        <ActiveEventRegistrationDetails
          GettingActiveRegistrationStatus={this.GettingActiveRegistrationStatus()}
        />
      </div>
    )
  }
